...
public class TierFourUpgrade extends BagUpgradeItemBase
{
    public TierFourUpgrade()
    {
        setUnlocalizedName(Reference.MOD_ID.toLowerCase() + "." + Names.BAG_TIER_4_NAME.toLowerCase());
        setRegistryName(Names.BAG_TIER_4_NAME);
        setMaxStackSize(64);
